...
const fileItem = tv({
  slots: {
    container:
      'group flex items-start gap-4 rounded-lg border border-r-zinc-200 p-4',
    icon: 'rounded-full border-4 border-r-violet-100 bg-violet-200 p-2 text-violet-600 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-500',
    deleteButton: '',
  },
      ...
      {state === 'error' ? (
        ...
        <div className="flex flex-1 flex-col items-start gap-1">
          ...
          <div className="flex w-full items-center gap-3">
            <div className="h-2 w-full rounded-full bg-zinc-100 dark:bg-zinc-600">
              <div
