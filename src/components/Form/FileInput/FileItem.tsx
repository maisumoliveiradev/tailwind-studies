...
export function FileItem({ name, size }: FileItemProps) {
  ...
  return (
    <div className="group flex items-start gap-4 rounded-lg border border-r-zinc-200 p-4">
      <div className="rounded-full border-4 border-r-violet-100 bg-violet-200 p-2 text-violet-600">
