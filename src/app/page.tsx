    ...
    <>
      ...
      <div className="mt-6 flex flex-col">
        ...
        >
          ...
          <div className="flex flex-col gap-6 pt-5 lg:grid lg:grid-cols-2">
            <label
              htmlFor="email"
              className="text-sm font-medium text-zinc-700 dark:text-zinc-300"
            >
            ...
            <Input.Root>
              ...
              <Input.Control
                id="email"
                type="email"
                defaultValue="viniciusdea.o@gmail.com"
              />
            </Input.Root>
          </div>
          ...
          <div className="flex flex-col gap-3 border-zinc-50 p-2 pt-5 lg:grid lg:grid-cols-2">
            <label
              htmlFor="role"
              className="text-sm font-medium text-zinc-700 dark:text-zinc-300"
            >
